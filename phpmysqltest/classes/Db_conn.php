...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'zwesterberg';//this will be your WCC username
      $dbUsr = 'zwesterberg';//this will be your WCC username
      $dbPass = 'dJQdMq8VpNuK0nb';//this will be the password found in the video.
